...
<form action="${pageContext.request.contextPath}/linkman/loginHandle" method="post">
    <div>
        ...
        <div>
            <table cellspacing=0 cellpadding=0 width=900 align=center border=0>
                ...
                <tr>
                    <td background="${pageContext.request.contextPath }/images/login_linkman.jpg" height=300>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px"
                                                     onclick="window.location.href='../manager/login.jsp'; "
